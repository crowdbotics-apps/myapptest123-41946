...
export const api_v1_detail_list = createAsyncThunk(
  "details/api_v1_detail_list",
  async payload => {
    const response = await apiService.api_v1_detail_list(payload)
    return response.data
  }
)
export const api_v1_detail_create = createAsyncThunk(
  "details/api_v1_detail_create",
  async payload => {
    const response = await apiService.api_v1_detail_create(payload)
    return response.data
  }
)
export const api_v1_detail_retrieve = createAsyncThunk(
  "details/api_v1_detail_retrieve",
  async payload => {
    const response = await apiService.api_v1_detail_retrieve(payload)
    return response.data
  }
)
export const api_v1_detail_update = createAsyncThunk(
  "details/api_v1_detail_update",
  async payload => {
    const response = await apiService.api_v1_detail_update(payload)
    return response.data
  }
)
export const api_v1_detail_partial_update = createAsyncThunk(
  "details/api_v1_detail_partial_update",
  async payload => {
    const response = await apiService.api_v1_detail_partial_update(payload)
    return response.data
  }
)
export const api_v1_detail_destroy = createAsyncThunk(
  "details/api_v1_detail_destroy",
  async payload => {
